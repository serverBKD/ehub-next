...
import img16 from "/public/products/product16.jpg";

function BrandShop() {
  return (
    <section className="w-full h-[640px] px-5 flex justify-center items-center flex-wrap md:w-[60%] md:mx-auto bg-[#F6F6F6]">
      <article className="w-[50%] min-h-[480px] md:basis-1/2 rounded-sm border-4 border-slate-400 overflow-hidden bg-white">
        <Image
          src={img16}
          alt="product16"
          style={{
      ...
      <article className="w-[50%] min-h-[480px] md:basis-1/2 text-black text-center font-bold grid grid-flow-row">
        <div>
